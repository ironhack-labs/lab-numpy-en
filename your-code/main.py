...
print (f" this is a {a}")
print (f" this is d {d}")
# the values in d are now the ones in a increased by 1, because both arrays were added element wise (all values of b were equal to 1)
...
equality = (e == a)
print(equality)
#because every value in a is multiplied by 1
