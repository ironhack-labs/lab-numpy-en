...
# No, these 2 numpy arrays cant be added cause they have different shapes. (2,3,5) vs (5,2,3)
...
d = a + c # Now it works cause there shapes match for the sum operation (2,3,5)
